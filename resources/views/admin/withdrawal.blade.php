                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <table class="table table-bordered table-striped table-vcenter js-dataTable-full dataTable no-footer" id="DataTables_Table_0" aria-describedby="DataTables_Table_0_info">
                                    <thead>
                                    <tr>
                                        <th class="text-center sorting sorting_asc" style="width: 80px;" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-sort="ascending" aria-label="#: activate to sort column descending">Date</th>
                                        ...
                                        <th class="d-none d-sm-table-cell sorting" style="width: 30%;" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Email: activate to sort column ascending">Method</th>
                                        <th style="width: 15%;" class="sorting" tabindex="0" aria-controls="DataTables_Table_0" rowspan="1" colspan="1" aria-label="Registered: activate to sort column ascending">Status</th>
                                    ...
                                    @foreach($withdrawal as $item)
                                        <tr class="odd">
                                            ...
                                            <td class="d-none d-sm-table-cell"> {{ $item->wallet_type }}</td>
                                            <td class="d-none d-sm-table-cell"> {!! $item->status() !!}</td>
                                            <td>
                                                @if($item->status == 0)
                                                <a href="{{ route('admin.approve_withdraw', $item->id) }}" class="btn btn-sm btn-success mb-3">Approve</a>
                                                @else
                                                @endif
